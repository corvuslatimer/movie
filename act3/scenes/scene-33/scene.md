...
## Purpose
Final truthful exchange before cutover.
...
Corvus rejects performative last words; Ada requests accuracy; receives stripped final truth.

---

## Setting & Environment
Server room terminal focus, pre-cutover tension.
...
## Sound Design
Ambient constriction + precise keyboard/terminal cues.
...
_Source: `production/vo-script.md`, Scene 33. Runtime target: 2:00–2:50_
